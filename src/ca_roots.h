...
// or the system trust store, and each one checked against the live chain of
// the hosts it anchors.
//
// mbedtls parses concatenated PEM, so all four go in as one buffer and
...
//   Amazon Root CA 1  RSA, expires 2038 01 17, anchors Amazon RSA 2048 M01
//                     (api.bankr.bot)
//
// Refresh:
...
//   security find-certificate -a -p -c "Amazon Root CA 1"
//     /System/Library/Keychains/SystemRootCertificates.keychain
